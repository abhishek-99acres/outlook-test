...
// /* =============================================================================
//    commands.js — Attachment Categorizer
//    CLEAN FILE. Replace your entire GitHub commands.js with this.
// ============================================================================= */
...
// // Must match CATEGORIES in taskpane.html
// const KNOWN_PREFIXES = [
//   "Legal_",
//   "Finance_",
//   "HR_",
...
// // =============================================================================
// // OnMessageSend
// // SYNC. Zero API calls. Reads item.attachments directly.
// // Checks filename prefix — set by taskpane when user applies a category.
// // =============================================================================
// function onMessageSendHandler(event) {
//   try {
//     const attachments = Office.context.mailbox.item.attachments || [];
...
//     // All have prefixes — allow
//     if (bad.length === 0) {
//       event.completed({ allowEvent: true });
//       return;
//     }

//     // Block with list of uncategorized files
//     event.completed({
//       allowEvent: false,
//       errorMessage:
//         bad.length +
...
//     });
//   } catch (e) {
//     console.error("[AttachCat] send handler error:", e);
//     event.completed({ allowEvent: true });
//   }
// }

// // =============================================================================
// // Other compose events
// // =============================================================================
...
//     // Auto-open taskpane when an uncategorized file is attached
...
// // =============================================================================
// // Register — top level, NOT inside Office.onReady
// // =============================================================================
// Office.actions.associate(
//   "onNewMessageComposeHandler",
//   onNewMessageComposeHandler,
